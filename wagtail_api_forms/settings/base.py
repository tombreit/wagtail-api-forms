...
FORMBUILDER_MAX_UPLOAD_SIZE = env.int("FORMBUILDER_MAX_UPLOAD_MB", default=3) * 1000 * 1000
FORMBUILDER_ALLOWED_DOCUMENT_FILE_TYPES = env.list("FORMBUILDER_ALLOWED_DOCUMENT_FILE_TYPES", default=[".pdf", ".txt"])
...
if DEBUG:
    print(f"{AUTH_LDAP=}")
    print(f"FORMBUILDER_MAX_UPLOAD_SIZE in MegaBytes is {FORMBUILDER_MAX_UPLOAD_SIZE / (1024 * 1024)}")
