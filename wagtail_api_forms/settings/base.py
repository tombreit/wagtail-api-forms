"""
Django settings for wagtail_api_forms project.
...
WAGTAILADMIN_BASE_URL = env.str("WAGTAIL_BASE_URL")
...
CSP_FRAME_ANCESTORS += tuple(env.list("CSP_FRAME_ANCESTORS"))
...
WHITELIST_IPS_ATTACHMENT_REQUEST = env.list("WHITELIST_IPS_ATTACHMENT_REQUEST")
...
USE_ANTIVIR_SERVICE = env.bool("USE_ANTIVIR_SERVICE", default=True)
